...
const HeroSection = () => {
  const handleWhatsAppClick = () => {
    window.open("https://wa.me/5511999999999?text=Olá,%20gostaria%20de%20saber%20mais%20sobre%20o%20app%20de%20fidelidade", "_blank");
  };
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          <div className="text-white space-y-8 fade-in-up">
            <h1 className="text-5xl lg:text-7xl font-bold leading-tight">
              O app de fidelidade que{" "}
              <span className="gradient-accent-text">transforma</span> seus
            ...
            <div className="grid grid-cols-3 gap-8 pt-12">
              <div className="text-center">
                <div className="text-3xl font-bold text-neon-lime">+40%</div>
                <div className="text-white/80">Recorrência</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-neon-lime">+25%</div>
                <div className="text-white/80">Ticket Médio</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-neon-lime">+60%</div>
          ...
          <div className="flex justify-center lg:justify-end fade-in-up">
            <div className="phone-mockup transform hover:scale-105 transition-transform duration-500">
              <div className="phone-frame">
                <img 
                  src={heroPhoneMockup} 
                  alt="App de fidelidade - Tela principal" 
